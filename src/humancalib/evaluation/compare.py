...
def main(argv=None):
    ...
    report = {"meta": meta, "engine": args.engine, "run": run, "scale_method": args.scale_method,
              "vertical_method": args.vertical_method, "stages": {}}
